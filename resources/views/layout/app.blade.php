          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="page-layouts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="{{url('user/reseller')}}">Reseller</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url('user/agent')}}">Agent</a></li>
