            ...
            <div class="row" style="margin-left:10px;margin-top:20px">
                <div class="col-md-3">
                    <div class="date_picker_pair mb-3">
                        <input type="number" class="form-control" id="amount" placeholder="Amount"  style="margin-top:30px">
                ...
                <div class="col-md-3">
                    <div class="date_picker_pair mb-3">
                    <input type="file" id="document" name="img[]" class="form-control file-upload-default"  style="margin-top:30px">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="date_picker_pair mb-3">
                    <textarea class="form-control" id="message" rows="3"  style="margin-top:30px" placeholder="Send Message (optional)" style="margin-top:30px"></textarea>
                    </div>
                </div>


                <div class="col-md-2">
                    <input type="button" onclick="submit_request()" value="Send Request" class="form-control btn btn-lg btn-success"
